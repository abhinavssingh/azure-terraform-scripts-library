...
Terraform module to generate Azure Keyvault.
...
| [azurerm_key_vault_access_policy.accesspolicy](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_access_policy) | resource |
...
| <a name="input_functionapp_object_id"></a> [functionapp\_object\_id](#input\_functionapp\_object\_id) | n/a | `string` | n/a | yes |
